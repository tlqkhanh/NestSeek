                        ...
                        <div className="w-full h-fit flex flex-col justify-center items-center">
                            <div className={classNames("w-[100%] flex flex-row ")}> 
                                ...
                                <div className="w-[50%] rounded-tr-xl p-4 flex flex-col justify-between">
                                    <div className={classNames('text-xl font-bold text-darkblue text-center', 'py-3')}>{data.name}</div>
                            ...
                            <div className="py-4 px-2">
                                ...
                                <div className={classNames('text-justify mt-4 text-indent-5 pl-5 pr-5')}>{data.description}</div>
                            </div>
                            <div className="flex justify-end w-full px-4 py-2">
                                <button className="py-2 px-3 bg-blue3 text-white font-semibold rounded-lg hover:bg-blue1" onClick={() => handleAdminAction('published',data.propertyID)}>Approve</button>
                                <button className="py-2 px-3 bg-blue3 text-white font-semibold rounded-lg hover:bg-blue1" onClick={() => handleAdminAction('rejected',data.propertyID)}>Reject</button>
                            </div>
                        </div>
                    </div>    
                ))}
