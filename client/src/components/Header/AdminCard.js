...
export default function AdminCard() {
  return (
    <Menu as="div" className="relative text-left px-2 w-full h-full flex">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-12 w-56 origin-top-right rounded-md bg-blue1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <a
